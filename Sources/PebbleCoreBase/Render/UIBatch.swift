...
public let GLYPHS: [Character: [Int]] = [
    ...
    // Punctuation the game had been writing all along without being able to
    // draw it. `glyphWidth` falls back to "?" for anything missing here, so
    // every em dash, ellipsis and status dot in the UI — ninety-odd of them,
    // in menus, chat and the multiplayer screens — was reaching players as a
    // literal question mark.
    "—": [0x08, 0x08, 0x08, 0x08, 0x08, 0x08], "–": [0x08, 0x08, 0x08, 0x08, 0x08],
    "−": [0x08, 0x08, 0x08, 0x08], "…": [0x60, 0x00, 0x60, 0x00, 0x60],
    "·": [0x08], "×": [0x22, 0x14, 0x08, 0x14, 0x22],
    "→": [0x08, 0x08, 0x2a, 0x1c, 0x08], "←": [0x08, 0x1c, 0x2a, 0x08, 0x08],
    "●": [0x1c, 0x3e, 0x3e, 0x3e, 0x1c], "✓": [0x10, 0x20, 0x10, 0x08, 0x04],
    "✕": [0x41, 0x22, 0x1c, 0x22, 0x41], "✗": [0x41, 0x22, 0x1c, 0x22, 0x41],
    "◡": [0x20, 0x40, 0x40, 0x40, 0x20], "∞": [0x1c, 0x22, 0x14, 0x22, 0x1c],
    // accented letters, drawn as the base letter plus its mark
    "é": [0x38, 0x56, 0x55, 0x54, 0x18], "ö": [0x38, 0x45, 0x44, 0x45, 0x38],
]
