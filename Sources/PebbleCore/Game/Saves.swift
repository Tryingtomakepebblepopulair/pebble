...
// <data root>/pebble.db (WAL mode, fully mutexed):
...
// Record value types live in SaveRecords.swift; this file is the SQLite
// store (Apple ships the SQLite3 module; Windows packaging comes with
// PORTING module 04).
