...
Sources/pebsmoke/     golden test harness (621 checks against goldens/*.json)
...
- If the engine itself seems wrong (worldgen, physics, redstone): the tail of `pebble test` — it should print `621 passed, 0 failed`.
